...
import styles from './GuestBeneficiaryStepFiveForm.component.module.css';

const GuestBeneficiaryStepFiveForm = props => {
...
export default reduxForm({
	form: 'GuestBeneficiaryStepFiveForm'
})(GuestBeneficiaryStepFiveForm);