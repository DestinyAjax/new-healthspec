...
class CompanyMyBeneficiary extends Component {
    ...
    componentDidMount() {
        this.props.getCompanyBeneficiary({
            slug: this.props.active.organization_profile.slug,
            page_number: 1
        });
    }
                        ...
                        <LayoutContent>
                            <div className="row">
                                ...
                                <div className="col-md-6 text-right">
                                    <Breadcrumb links={[
                                        {
                                            url: `/dashboard/company_my_beneficiary`,
                                            name: 'Enrollees'
                                        },
                                    ]} />
                                </div>
...
export default connect(mapStateToProps, mapDispatchToProps)(CompanyMyBeneficiary);